        ...
        <div className="flex gap-10">
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-3">
              <h3 className="text-primary-dark">Тесленко Михайло Сергійович</h3>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-primary-main">
                ...
                підозрюваних, обвинувачених, засуджених або виправданих осіб, а
                також осіб, щодо яких застосовуються примусові медичні чи
                виховні заходи. Надання юридичної допомоги свідкам у
                кримінальних провадженнях, представництво інтересів потерпілих у
                справах про адміністративні правопорушення, а також цивільних
                позивачів і відповідачів у кримінальних справах.
              </p>
              <p className="text-primary-main">
                Представництво інтересів клієнтів у цивільних, господарських,
                адміністративних та конституційних судах, у державних установах,
                а також у взаєминах з іншими фізичними та юридичними особами.
              </p>
            </div>
          </div>
        </div>
